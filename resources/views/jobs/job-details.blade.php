...
<!-- Mirrored from demo.foxthemes.net/socialitev2.1/job-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Aug 2021 22:05:16 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <div class="lg:flex  lg:space-x-12">
                    ...
                    <div class="lg:w-3/4   card">
                        ...
                        <div class="md:p-7 p-3">
                            <h2 class="text-2xl font-bold">  Technical Event Support Specialist </h2>
                            <p> Slivon Technician Service </p>
                        </div>
