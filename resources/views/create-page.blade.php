...
<!-- Mirrored from demo.foxthemes.net/socialitev2.1/create-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Aug 2021 22:05:15 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <div class="sidebar">
            ...
            <div class="sidebar_inner" data-simplebar>
                ...
                <ul>
                    ...
                    <li class="active" id="more-veiw" hidden><a href="albums.html"> 
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="text-blue-500">
        ...
        <div class="main_content">
            <div class="mcontainer">
                ...
                <div class="max-w-2xl m-auto shadow-md rounded-md bg-white lg:mt-20">  
                    ...
                    <!-- form footer -->
                    <div class="border-t flex justify-between lg:space-x-10 p-6 bg-gray-50 rounded-b-md">
                        <p class="text-sm"> You can add images, contact info and other details after you create the Page. </p>
