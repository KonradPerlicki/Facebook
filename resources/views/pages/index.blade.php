...
<!-- Mirrored from demo.foxthemes.net/socialitev2.1/pages.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Aug 2021 22:02:19 GMT -->
<head>
    <meta charset="UTF-8">
                                    ...
                                    <li>
                                        <a href="timeline-page.html">
                                          <div class="card">
                                            ...
                                            <div class="p-3">
                                               <h4 class="text-base font-semibold mb-0.5">John Michael   </h4>
                                               <p class="font-medium text-sm">843K Following
                                            </p></div>
                                          </div>
                                       </a>
                                    ...
                                    <li>
                                        <a href="timeline-page.html">
                                          <div class="card">
                                            ...
                                            <div class="p-3">
                                               <h4 class="text-base font-semibold mb-0.5"> Monroe Parker  </h4>
                                               <p class="font-medium text-sm">843K Following
                                            </p></div>
                                          </div>
                                       </a>
                                    ...
                                    <li>
                                        <a href="timeline-page.html">
                                          <div class="card">
                                            ...
                                            <div class="p-3">
                                               <h4 class="text-base font-semibold mb-0.5">  Martin Gray   </h4>
                                               <p class="font-medium text-sm">843K Following
                                            </p></div>
                                          </div>
                                       </a>
                                    ...
                                    <li>
                                        <a href="timeline-page.html">
                                          <div class="card">
                                            ...
                                            <div class="p-3">
                                               <h4 class="text-base font-semibold mb-0.5">Jesse Stevens      </h4>
                                               <p class="font-medium text-sm">843K Following
                                            </p></div>
                                          </div>
                                       </a>
