...
<!-- Mirrored from demo.foxthemes.net/socialitev2.1/videos.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Aug 2021 22:02:19 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <div class="sidebar">
            ...
            <div class="sidebar_inner" data-simplebar>
                ...
                <ul>
                    ...
                    <li class="active"><a href="videos.html">
                        ...
                        <ul class="uk-slider-items uk-child-width-1-4@m uk-child-width-1-3@s uk-child-width-1-2 uk-grid-small uk-grid">
                            ...
                            <li>
                                ...
                                <div class="pt-3">
                                    ...
                                    <div class="pt-2">
                                        <a href="#" class="text-sm"> Morning Star</a>
                                        <div class="flex space-x-2 items-center text-xs">
                                            <div> 27 weeks ago</div>
                                            <div class="md:block hidden">·</div>
                                            <div> 156.9K views</div>
                            ...
                            <li>
                                ...
                                <div class="pt-3">
                                    ...
                                    <div class="pt-2">
                                        <a href="#" class="text-sm"> by <a href="#"> Smart waves </a> </a>
                                        <div class="flex space-x-2 items-center text-xs">
                                            <div> 27 weeks ago</div>
                                            <div class="md:block hidden">·</div>
                                            <div> 156.9K views</div>
              ...
              <form action="#" class="space-y-4 g:w-8/12">
                  ...
                  <div class="border focus-within:bg-white focus-within:border-blue-300 p-3 pb-0 rounded-md">
                      ...
                      <input type="text" placeholder="Name"
                          class="-mt-2 -mx-3 bg-transparent focus:bg-white focus:ring-gray-300 h-8 outline-none px-0 text-base w-full">
                  </div>
                  <div class="border focus-within:bg-white focus-within:border-blue-300 p-3 rounded-md">
                      ...
                      <textarea type="text" rows="5" placeholder="What's Your Mind ? Stella!"
                          class="bg-transparent focus:bg-white focus:ring-gray-300 focus:shadow-none outline-none p-2 resize-none shadow-none text-base w-full"></textarea>
                  </div>
                  <div class="keywords-container">
                      ...
                      <div class="keywords-list">
                          <span class="keyword">
                              <span class="keyword-remove">Javascript</span> <span class="keyword-text"></span>
                          </span>
                          <span class="keyword">
