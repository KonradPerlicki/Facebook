...
<!-- Mirrored from demo.foxthemes.net/socialitev2.1/forums.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Aug 2021 22:05:13 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <div class="sidebar">
            ...
            <div class="sidebar_inner" data-simplebar>
                ...
                <ul>
                    ...
                    <li class="active" id="more-veiw" hidden><a href="forums.html"> 
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="text-blue-500">
                            ...
                            <li>
                                <a href="#">
                                    <div class="flex items-start space-x-4 p-4">
                                        ...
                                        <div class="flex-1">
                                            <h3 class="text-lg font-semibold line-clamp-1 mb-1">I have only recently found this particular keyword.  </h3>
                            ...
                            <li>
                                <a href="#">
                                    <div class="flex items-start space-x-4 p-4">
                                        ...
                                        <div class="flex-1">
                                            <h3 class="text-lg font-semibold line-clamp-1 mb-1"> Stuck on Please wait for hosting to be configured  </h3>
                                            <p class="text-sm text-gray-400 mb-2"> Posted By: <span data-href="%40tag-dev.html">Tag-dev</span> 8 hours ago</span> </p>
                                          <p class="leading-6 line-clamp-2 mt-3">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat</p>
                                        </div>
                                        <div class="sm:flex items-center space-x-4 hidden">
                            ...
                            <li>
                                <a href="#">
                                    <div class="flex items-start space-x-4 p-4">
                                        ...
                                        <div class="flex-1">
                                          <h3 class="text-lg font-semibold line-clamp-1 mb-1"> Messing around with it, one use I found is by overriding </h3>
                                      <p class="text-sm text-gray-400 mb-2"> Posted By: <span data-href="%40tag-dev.html">Tag-dev</span> 8 hours ago</span> </p>
                                          <p class="leading-6 line-clamp-2 mt-3">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat</p>
                                        </div>
                                        <div class="sm:flex items-center space-x-4 hidden">
                            ...
                            <li>
                                <a href="#">
                                    <div class="flex items-center space-x-5 p-4">
                                        <img src="assets/images/avatars/avatar-1.jpg" alt="" class="w-12 h-12 rounded-full">
                                        <div class="flex-1">
                                            <h3 class="text-lg font-semibold line-clamp-1"> Recommendations for new computer </h3>
                                            <div class="flex space-x-3 text-sm pb-2 mt-1 flex-wrap"> 
                                                <div class="font-semibold"> Adrian Jackson </div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="flex items-center space-x-5 p-4">
                                        <img src="assets/images/avatars/avatar-2.jpg" alt="" class="w-12 h-12 rounded-full">
                                        <div class="flex-1">
                                            <h3 class="text-lg font-semibold line-clamp-1"> Once more about streaks  </h3>
    
                                            <div class="flex space-x-3 text-sm pb-2 flex-wrap"> 
                                                <div class="font-semibold">  Adrian Mohani  </div>
                                                <div class="text-gray-500"> Oct 20Th , 2020 </div>
                                                <div class="text-gray-500"> 12 replies</div>
                                            </div>
                                        </div>
                            ...
                            <li>
                              <a href="#">
                                  <div class="flex items-center space-x-5 p-4">
                                      ...
                                      <div class="flex-1">
                                          <h3 class="text-lg font-semibold line-clamp-1"> Stuck on Please wait for hosting to be configured  </h3>
                                          <div class="flex space-x-3 text-sm pb-2 mt-1 flex-wrap"> 
                            ...
                            <li>
                                <a href="#">
                                    <div class="flex items-center space-x-5 p-4">
                                        <img src="assets/images/avatars/avatar-2.jpg" alt="" class="w-12 h-12 rounded-full">
                                        <div class="flex-1">
                                            <h3 class="text-lg font-semibold line-clamp-1"> Messing around with it, one use I found is by overriding  </h3>
                                            <div class="flex space-x-3 text-sm pb-2 mt-1 flex-wrap"> 
                                                <div class="font-semibold"> Jesse Stevens </div>
                                                <div class="text-gray-500"> Oct 20Th , 2020 </div>
                                                <div class="text-gray-500"> 12 replies</div>
                                            </div>
                                        </div>
...
<!-- Mirrored from demo.foxthemes.net/socialitev2.1/forums.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Aug 2021 22:05:14 GMT -->
</html>